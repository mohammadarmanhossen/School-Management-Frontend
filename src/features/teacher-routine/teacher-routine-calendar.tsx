...
export function TeacherRoutineCalendar() {
  ...
  const handleEventDrop = (info: any) => {
    toast.info("Drag & drop to reschedule is restricted for recurring weekly templates.");
    info.revert();
  };
  ...
  const handleEventClick = (info: any) => {
    ...
    toast(`Class Details`, {
      description: `${props.subjectName} for ${props.className} by ${props.teacherName} in ${props.room}.`,
    });
  };
